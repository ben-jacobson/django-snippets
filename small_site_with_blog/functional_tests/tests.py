...
class AdminPageTests(FunctionalTest):
    ...
    def test_list_of_blog_entries_show_published_status(self):
        ...
        string_from_time = datetime.strftime(timezone.localtime(), "%b. %d, %Y")  # this may break, unsure if the zero padding on the day matches what the admin page displays. If in doubt, just change this to just ', %Y'
